                                    ...
                                    if ($select_comment->rowCount() > 0) {
                                        while ($fetch_comment = $select_comment->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="col-2" style="border: 1px solid #0b6e4f;">
                                                    <img src="uploaded_img/reviews/<?= htmlspecialchars($fetch_comment['image']); ?>"
                                                        alt="" width="50%">
                                                </td>
                                                <td class="pt-4" style="border: 1px solid #0b6e4f;">
                                                ...
                                                <td class="pt-4" style="border: 1px solid #0b6e4f;">
                                                    <a class="btn btn-danger"
                                                        data-id="<?= htmlspecialchars($fetch_comment['id']); ?>"
