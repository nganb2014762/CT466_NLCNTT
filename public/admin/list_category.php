                                ...
                                <table class="table text-center" style="border-collapse: collapse;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col"
                                                style="background-color: #0b6e4f; border: 1px solid #0b6e4f;">Name</th>
                                            <th scope="col"
                                                style="background-color: #0b6e4f; border: 1px solid #0b6e4f;">Edit</th>
                                            <th scope="col"
                                                style="background-color: #0b6e4f; border: 1px solid #0b6e4f;">Delete
                                            </th>
                                        </tr>
                                    </thead>
                                        ...
                                        if ($show_category->rowCount() > 0) {
                                            while ($fetch_category = $show_category->fetch(PDO::FETCH_ASSOC)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pt-4" style="border: 1px solid #0b6e4f;">
                                                        <span><?= htmlspecialchars($fetch_category['name']); ?></span>
                                                    </td>
                                                    <td class="pt-4" style="border: 1px solid #0b6e4f;">
                                    ...
                                    <div class="card shadow-sm">
                                        <div class="card-body">
                                            <form id="product-form" action="" method="POST"
                                                ...
                                                <div class="form-group">
                                                    <input type="submit" class="btn w-100  shadow-sm"
                                                        value="Add category" name="add_category"
                                                        style="background-color: #0b6e4f;color: black;">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
