            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="list_products.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" style="background-color: #0b6e4f;"><i
                                class="fas fa-solid fa-list fa-sm text-white-50"></i> Danh sách sản phẩm</a>
                    </div>

                    <section class="">
                        <div class="container text-center">
                            <h2 class="position-relative d-inline-block" style="color: black;">Thông tin sản phẩm</h2>
                            <!-- <hr class="mx-auto"> -->
                        </div>
