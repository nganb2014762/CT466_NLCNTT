            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="add_products.php" class="d-none d-sm-inline-block btn btn-sm  shadow-sm"
                            style="background-color: #0b6e4f; color:black"><i
                                class="fas fa-solid fa-plus fa-sm text-white-50" style="background-color: #0b6e4f;"></i>
                            Thêm sản phẩm</a>
                    </div>
                        ...
                        <table class="table text-center" style="border-collapse: collapse;">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" style="background-color: #0b6e4f; border: 1px solid #0b6e4f;">
                                        Quantity</th>
                                    <th scope="col" style="background-color: #0b6e4f; border: 1px solid #0b6e4f;">Price
                                    </th>
                                    <th scope="col" style="background-color: #0b6e4f; border: 1px solid #0b6e4f;">
                                        Details</th>
